...
public class ApplyInsuarnce {
	...
	public void applyinsurance() {
		...
		driver.findElement(By.xpath("//span[@aria-label='February 12, 1998']")).click();
		...
		driver.findElement(By.xpath("(//div[@date='2022-02-12'])[1]")).click();
...
//		
//		WebElement cityName = driver.findElement(By.xpath("//input[@placeholder='City']"));
//		cityName.click();
